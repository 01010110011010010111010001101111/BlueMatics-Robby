...
int LINE_DETECTOR_LEFT;
int LINE_DETECTOR_RIGHT;
int LINE_DETECTOR_MID_LEFT;
int LINE_DETECTOR_MID_RIGHT;
...
//#define VOICE_PAUSE                   PORTE.1
//NOT IN USE #define PORTE.2
//#define VOICE_PREV                    PORTE.3
#define WHEEL_ENCODER_RIGHT           PINE.4
//#define VOICE_NEXT                    PORTE.5
#define WHEEL_ENCODER_LEFT            PINE.6
#define ECHO                          PINE.7

  /////////////PORT F////////////// 

#define LINE_DETECTOR_LEFT_ADC       adc_data[0]
#define LIGHT_SENSOR_LEFT            adc_data[1]
#define LINE_DETECTOR_MID_LEFT_ADC   adc_data[2]
#define LIGHT_SENSOR_RIGHT           adc_data[3]
#define LINE_DETECTOR_MID_RIGHT_ADC  adc_data[4]
//NOTI IN USE#define PORTF.5
#define LINE_DETECTOR_RIGHT_ADC      adc_data[6]
...
long int wheelEncoderCounter_left  = 0;
long int wheelEncoderCounter_right = 0;           
// External Interrupt 4 Wheel encoder Left
 interrupt [EXT_INT4] void ext_int4_isr(void)
 {
 if (wheelEncoderCounter_right>=-20000&wheelEncoderCounter_right<20000){ 
 
  
  if(ENGINE_DIRECTION_LEFT==1){wheelEncoderCounter_right--;}else{wheelEncoderCounter_right++;} 
...
// External Interrupt 6 Wheel encoder Right
 ...
 {
 if (wheelEncoderCounter_left>=-20000&wheelEncoderCounter_left<20000){  
 
  if(ENGINE_DIRECTION_RIGHT==1){wheelEncoderCounter_left--;}else{wheelEncoderCounter_left++;}
