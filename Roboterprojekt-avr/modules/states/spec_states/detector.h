...
void line_detector(){
  ...
  if (     (iTime/52.2)<30)detector_value=64;    
...
void detectorcase_line(){
   ...
   //Robby is driving a spiral (right)
     movement(val_L_linesearch,30,0,0); 
     puts("nothing");
   break;   
