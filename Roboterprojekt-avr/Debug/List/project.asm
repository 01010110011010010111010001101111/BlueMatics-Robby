...
; 0000 0050 port_init();
	CALL _port_init
; 0000 0051 //Other inits
; 0000 0052 i2c_init();
	CALL _i2c_init
; 0000 0053 wii_cam_init();
	CALL _wii_cam_init
; 0000 0054 twiinit();
	RCALL _twiinit
; 0000 0055 
...
_0x24E:
; 0000 0057       {
; 0000 0058       detector();           //SENSOR_DETECTOR
	CALL _detector
; 0000 0059       STATE_MACHINE();      //DEFAULT_STATE_MACHINE
	RCALL _STATE_MACHINE
; 0000 005A       esp_states();         //ESP_STATE_MACHINE
	CALL _esp_states
; 0000 005B       ondata();             //IR_DATA_FUNCTION
	CALL _ondata
; 0000 005C       esp_mainfunctions();  //ESP_MAIN_FUNCTIONS
