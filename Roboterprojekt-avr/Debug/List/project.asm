...
_0x20D:
	CALL _lcd_clear
	__POINTW2MN _0x1E8,318
	CALL SUBOPT_0x7
	__POINTW2MN _0x1E8,332
	CALL _lcd_puts
_0x1E5:
	LDI  R26,LOW(50)
	LDI  R27,0
