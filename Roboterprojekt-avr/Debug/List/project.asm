...
_0xE3:
	CALL SUBOPT_0x25
	CALL SUBOPT_0x26
	__POINTW2MN _0xD0,14
	CALL SUBOPT_0x27
	__POINTW2MN _0xD0,17
	CALL SUBOPT_0x28
	CALL SUBOPT_0x1
	SBIW R26,17
	BRLT _0xE3
...
_0xEE:
	CALL SUBOPT_0x23
	CALL SUBOPT_0x2B
	__POINTW2MN _0xD0,21
	CALL SUBOPT_0x27
	__POINTW2MN _0xD0,24
	CALL SUBOPT_0x28
	CALL SUBOPT_0x4
	CPI  R26,LOW(0x64)
	LDI  R30,HIGH(0x64)
...
_0x129:
	CALL _lcd_clear
	__POINTW2MN _0x104,318
	CALL SUBOPT_0x7
	__POINTW2MN _0x104,332
	CALL _lcd_puts
_0x101:
	LDI  R26,LOW(50)
_0x20E0003:
...
; .FSTART _timer1_ovf_isr
	CALL SUBOPT_0x0
; 0000 005C   // Reinitialize Timer 1 value
; 0000 005D   TCNT1L=0x9C;
	LDI  R30,LOW(156)
	OUT  0x2C,R30
; 0000 005E   ipwmcounter++;
...
; 0000 0062 
; 0000 0063 
; 0000 0064   if (ipwmcounter>255)
	CALL SUBOPT_0x2D
	CPI  R26,LOW(0x100)
	LDI  R30,HIGH(0x100)
	CPC  R27,R30
	BRLT _0x12F
; 0000 0065     ipwmcounter=0;
	LDI  R30,LOW(0)
...
; 0000 006C 
; 0000 006D 
; 0000 006E  if(ipwmcounter >= ipwmcompareleft){
_0x12F:
	...
	CPC  R27,R31
	BRLT _0x130
; 0000 006F  ENGINE_ENABLE_LEFT=0;
	CBI  0x1B,3
; 0000 0070   }else{
	RJMP _0x133
_0x130:
; 0000 0071   ENGINE_ENABLE_LEFT=1;
	SBI  0x1B,3
; 0000 0072   }
_0x133:
; 0000 0073 
; 0000 0074  if(ipwmcounter >= ipwmcompareright){
	...
	CPC  R27,R31
	BRLT _0x136
; 0000 0075  ENGINE_ENABLE_RIGHT=0;
	CBI  0x1B,1
; 0000 0076   }else{
	RJMP _0x139
_0x136:
; 0000 0077   ENGINE_ENABLE_RIGHT=1;}
	SBI  0x1B,1
_0x139:
; 0000 0078 }
	LD   R30,Y+
...
_main:
; .FSTART _main
; 0000 0081 // Ports initialisieren
; 0000 0082 port_init();
	CALL _port_init
; 0000 0083 //Other inits
; 0000 0084 i2c_init();
	CALL _i2c_init
; 0000 0085 wii_cam_init();
	RCALL _wii_cam_init
; 0000 0086 twiinit();
	RCALL _twiinit
; 0000 0087 
...
_0x13C:
; 0000 0089       {
; 0000 008A       STATE_MACHINE();
	RCALL _STATE_MACHINE
; 0000 008B       esp_states();
	RCALL _esp_states
; 0000 008C 
; 0000 008D       ondata();
	RCALL _ondata
; 0000 008E       esp_mainfunctions();
